...
class state {
    ...
    index ( x, y ) { return x * config.data.geometry.maxh + y; }

    get born () { return config.data.rules.born; }
    get range () { return config.data.rules.neighborhood.range; }
    get survive () { return config.data.rules.survive; }
    get tiling () { return config.data.grid.tiling; }
    get vicinity () { return config.data.rules.neighborhood.vicinity; }

    get height () { return config.data.geometry.height; }
    get maxh () { return config.data.geometry.maxh; }
    get maxw () { return config.data.geometry.maxw; }
    get width () { return config.data.geometry.width; }

    get bottom () { return config.data.geometry.bottom; }
    get left () { return config.data.geometry.left; }
    get right () { return config.data.geometry.right; }
    get top () { return config.data.geometry.top; }
...
const game = new class extends board {
    ...
    redraw ( newｰstate ) {
            ...
            // then paint (new) state cells in live colors
