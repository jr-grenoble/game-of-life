...
const game = new class extends elements {
                ...
                grid: {
                    value: new class extends toggle {
                                    ...
                                    option => {
                                            ...
                                            this.types [ name ] = new class extends radioｰbutton {
                                                constructor ( grid ) {
                                                        ...
                                                        // this.baseｰwidth = parseFloat ( this.baseｰvisibleｰurl.replace ( /.*\sfont-size\s*=\s*'([0-9.]*).*/, "$1" ) );
                                                        }
                        ...
                        paint () { /* a valid CSS color, such as transparent or #e0e0e0 */
                                ...
                                this.type = config.data.grid.type;
                                }
    ...
    resize () {
            ...
            const w = ᒪｘꓹｓᒧ ( ᒪｘᒧ ( cs.width ) - ᒪｘᒧ ( cs.paddingLeft ) - ᒪｘᒧ ( cs.paddingRight ), this.grid.width ) + 1;
            const h = ᒪｘꓹｓᒧ ( ᒪｘᒧ ( cs.height ) - ᒪｘᒧ ( cs.paddingTop ) - ᒪｘᒧ ( cs.paddingBottom ) - ᒪｘᒧ ( cs.marginTop ) - ᒪｘᒧ ( cs.marginBottom ), this.grid.height ) + 1;
