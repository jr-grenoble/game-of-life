...
const neighborhoods = {
    moore: {
        ...
        triangle ( range, index, x, y ) {
                 ...
                 */
                 ...
                 // TODO CHECK ROTATIONS WHEN CENTER IS POINTING LEFT (x+y) ODD !!!!
    ...
    vonｰneumann: {
        ...
        triangle ( range, index, x, y ) {
                // TODO !! fake function
                return neighborhoods.moore.triangle ( range, index, x, y );
                }
        }
    };
...
export default class eternalｰview {
    ...
    constructor () {
            ...
            game.config.colors.alpha.alpha = config.data.trail.alpha;
